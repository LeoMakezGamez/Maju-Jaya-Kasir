        ...
        <section class="unit-section">
            <div class="unit-header">
                ...
                <a href="{{ route('category.create') }}" type='button'>
                    <button class="btn btn-add"><i class='bx bx-plus'></i> Tambah Category</button></a>
            </div>
            ...
            <table class="unit-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $value->item_category_code }}</td>
                        <td>
                            <div class="action-buttons">
                                ...
                                <a href="{{ route('category.edit', $value->id) }}" role="button" class="btn btn-edit"><i class='bx bx-edit-alt'></i> Edit</a>
                            </div>
                        </td>
